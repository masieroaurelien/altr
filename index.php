		...
		<div class="container">
			...
			<div class="container flex">
				<div class="case">
					...
					<p class="index">Tu galères à trouver une entreprise pour t’accueillir en alternance ? Tu ne tombes que sur des stages sous-payés exigeants plusieurs années d’XP ? Tu enchaines refus sur refus, ton rêve de reconversion s’éloigne au fil des jours ?</p>
				</div>
				...
				<div class="case">
					...
					<p class="index">On te comprend, on est passé par là. Sauter le pas de la reconversion, affronter la peur de l’inconnu, se bouger pour trouver la formation qui nous correspond ça n'a jamais été facile.</p>
				</div>
				...
				<div class="case">
					...
					<p class="index">Avec ALT-R, on veut t’aider à reprendre du poil de la bête et te conseiller du mieux possible pour que tu puisses décrocher ton contrat d’alternance, et réussir ton projet professionnel !</p>
				</div>
			</div>
