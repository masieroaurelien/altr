                ...
                <div class="slider">
                    <div class="mask">
                        <ul class="alternanceart">
                            <li class="anim1">
                              	<div class="quote">Tu veux rejoindre l’univers tech & digital en passant par la case alternance ? <br> Tu as ouvert le bon onglet et celui-ci, tu peux le mettre en favori.</div>
                              	<div class="source">- Le collectif</div>
                            </li>
                            <li class="anim2">
                              	<div class="quote">ALT-R te donne accès gratuitement aux conseils et aux témoignages de ceux qui <br> sont aussi passés par là pour t’aider à trouver une alternance.</div>
                              	<div class="source">- Le collectif</div>
                            </li>
                        </ul>
                    </div>
