<footer>
	<img src="../medias/logo/logot.png" class="footer">
	<div class="footer">
		<nav class="footer">
			<ul class="footer">
				<title class="footer">Menu</title>
					<a href="../index.php" class="footer"><li class="footer">Accueil</li></a>
			...
			<ul class="footer">
				<title class="footer">Autre</title>
					<a href="mention.php" class="footer"><li class="footer">Mentions légales</li></a>
			</ul>
		</nav>
	</div>
</footer>